...
/*
Project 3: 
1)Implemented encoding for the previously unsupported instructions:
bge, beq, jal, jalr, sll, sd
2)Made code structure improvements - now there are more job-oriented functions to improve scalability
*/
...
void setInstructionInf(int *opcode, int *funct3, int *funct7, char **type, char *opr){
    ...
    if (strcmp(opr, "sub") == 0) //slli instruction
    {
        *type = "R";
        *opcode = 51;
        *funct3 = 0;

...
HD_PWD='D:/xlinx-projects/snoop_controller_timer/snoop_controller_timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scutimer_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scutimer_wrapper.tcl

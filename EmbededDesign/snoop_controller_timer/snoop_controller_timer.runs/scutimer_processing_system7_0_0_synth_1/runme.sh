...
HD_PWD='D:/xlinx-projects/snoop_controller_timer/snoop_controller_timer.runs/scutimer_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scutimer_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scutimer_processing_system7_0_0.tcl

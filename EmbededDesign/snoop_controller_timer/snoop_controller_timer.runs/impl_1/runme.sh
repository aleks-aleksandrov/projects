...
HD_PWD='D:/xlinx-projects/snoop_controller_timer/snoop_controller_timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scutimer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scutimer_wrapper.tcl -notrace

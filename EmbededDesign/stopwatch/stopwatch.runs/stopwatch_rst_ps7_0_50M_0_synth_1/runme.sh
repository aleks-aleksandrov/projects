...
HD_PWD='D:/xlinx-projects/stopwatch/stopwatch.runs/stopwatch_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_rst_ps7_0_50M_0.tcl

...
HD_PWD='D:/xlinx-projects/stopwatch/stopwatch.runs/stopwatch_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_axi_gpio_0_0.tcl

...
HD_PWD='D:/xlinx-projects/stopwatch/stopwatch.runs/stopwatch_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_auto_pc_0.tcl

...
HD_PWD='D:/xlinx-projects/knight_rider/knight_rider.runs/knight_rider_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rider_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knight_rider_axi_gpio_0_0.tcl

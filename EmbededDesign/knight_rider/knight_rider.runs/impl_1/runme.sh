...
HD_PWD='D:/xlinx-projects/knight_rider/knight_rider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rider_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source knight_rider_wrapper.tcl -notrace

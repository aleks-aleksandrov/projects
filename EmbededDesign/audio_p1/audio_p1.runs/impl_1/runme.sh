...
HD_PWD='D:/xlinx-projects/audio_p1/audio_p1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_design_wrapper.tcl -notrace

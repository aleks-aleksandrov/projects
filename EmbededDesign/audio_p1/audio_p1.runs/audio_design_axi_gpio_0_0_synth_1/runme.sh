...
HD_PWD='D:/xlinx-projects/audio_p1/audio_p1.runs/audio_design_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_design_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_design_axi_gpio_0_0.tcl

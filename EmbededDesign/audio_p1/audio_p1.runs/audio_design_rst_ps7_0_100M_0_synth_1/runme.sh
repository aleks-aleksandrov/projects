...
HD_PWD='D:/xlinx-projects/audio_p1/audio_p1.runs/audio_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_design_rst_ps7_0_100M_0.tcl

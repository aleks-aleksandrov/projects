...
#define REC_TIME_SEC 25
#define REC_SAMPLES (REC_TIME_SEC * 48000) /* Sample rate of 48000Hz */

#define DELAY_SEC 0.33 // *Only change this value (float)
#define DELAY DELAY_SEC*96000 //24000
...
int AudioDelayFeedback(u32 i2sAddr, u32 uartAddr);
void AudioPrintMenu();

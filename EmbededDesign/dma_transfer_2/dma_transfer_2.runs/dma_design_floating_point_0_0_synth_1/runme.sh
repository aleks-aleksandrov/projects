...
HD_PWD='D:/xlinx-projects/dma_transfer_2/dma_transfer_2.runs/dma_design_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_design_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_design_floating_point_0_0.tcl

...
--Command     : generate_target custo_ip_tb_wrapper.bd
--Design      : custo_ip_tb_wrapper
...
end custo_ip_tb_wrapper;

architecture STRUCTURE of custo_ip_tb_wrapper is
  component custo_ip_tb is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component custo_ip_tb;
begin
custo_ip_tb_i: component custo_ip_tb
     port map (

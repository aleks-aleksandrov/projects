...
HD_PWD='D:/xlinx-projects/custom_ip_tb/custom_ip_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log custo_ip_tb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source custo_ip_tb_wrapper.tcl -notrace

...
HD_PWD='D:/xlinx-projects/custom_ip_tb/custom_ip_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custo_ip_tb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custo_ip_tb_wrapper.tcl

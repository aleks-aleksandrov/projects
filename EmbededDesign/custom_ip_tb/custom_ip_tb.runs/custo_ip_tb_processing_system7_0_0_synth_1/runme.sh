...
HD_PWD='D:/xlinx-projects/custom_ip_tb/custom_ip_tb.runs/custo_ip_tb_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custo_ip_tb_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custo_ip_tb_processing_system7_0_0.tcl

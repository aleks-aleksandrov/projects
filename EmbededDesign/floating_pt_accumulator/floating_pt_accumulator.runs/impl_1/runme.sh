...
HD_PWD='D:/xlinx-projects/floating_pt_accumulator/floating_pt_accumulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accumulator_design_wrapper.tcl -notrace

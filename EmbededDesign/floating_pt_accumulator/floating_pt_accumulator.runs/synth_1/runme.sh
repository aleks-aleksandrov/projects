...
HD_PWD='D:/xlinx-projects/floating_pt_accumulator/floating_pt_accumulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accumulator_design_wrapper.tcl

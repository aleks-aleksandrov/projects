...
HD_PWD='D:/xlinx-projects/floating_pt_accumulator/floating_pt_accumulator.runs/accumulator_design_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_design_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accumulator_design_floating_point_0_0.tcl

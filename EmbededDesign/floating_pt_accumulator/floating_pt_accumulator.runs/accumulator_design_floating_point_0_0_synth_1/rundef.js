...
ISEStep( "vivado",
         "-log accumulator_design_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accumulator_design_floating_point_0_0.tcl" );

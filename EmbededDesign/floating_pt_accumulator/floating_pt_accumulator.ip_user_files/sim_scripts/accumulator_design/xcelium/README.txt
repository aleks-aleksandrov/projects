...
#
# Generated by export_simulation on Thu Feb 18 12:04:27 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './accumulator_design.sh' script.

./accumulator_design.sh -reset_run
...
./accumulator_design.sh -noclean_files

For more information on the script, please type './accumulator_design.sh -help'.

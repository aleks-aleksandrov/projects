...
HD_PWD='D:/xlinx-projects/gpio_with_interrupt/gpio_with_interrupt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_interrupt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_interrupt_wrapper.tcl -notrace

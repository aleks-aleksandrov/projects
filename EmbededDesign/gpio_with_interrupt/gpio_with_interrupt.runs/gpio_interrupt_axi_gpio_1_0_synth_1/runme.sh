...
HD_PWD='D:/xlinx-projects/gpio_with_interrupt/gpio_with_interrupt.runs/gpio_interrupt_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_interrupt_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_interrupt_axi_gpio_1_0.tcl

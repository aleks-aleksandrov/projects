...
#
# Generated by export_simulation on Tue Feb 16 14:05:39 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './kn_rd_tb.sh' script.

./kn_rd_tb.sh -reset_run
...
./kn_rd_tb.sh -noclean_files

For more information on the script, please type './kn_rd_tb.sh -help'.

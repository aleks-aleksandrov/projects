...
HD_PWD='D:/xlinx-projects/knight_rider_ip_tb/knight_rider_ip_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kn_rd_tb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kn_rd_tb_wrapper.tcl

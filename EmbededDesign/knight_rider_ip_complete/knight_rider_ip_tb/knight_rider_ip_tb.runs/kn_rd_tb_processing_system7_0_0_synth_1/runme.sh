...
HD_PWD='D:/xlinx-projects/knight_rider_ip_tb/knight_rider_ip_tb.runs/kn_rd_tb_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kn_rd_tb_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kn_rd_tb_processing_system7_0_0.tcl

...
HD_PWD='D:/xlinx-projects/knight_rider_ip_tb/knight_rider_ip_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kn_rd_tb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kn_rd_tb_wrapper.tcl -notrace

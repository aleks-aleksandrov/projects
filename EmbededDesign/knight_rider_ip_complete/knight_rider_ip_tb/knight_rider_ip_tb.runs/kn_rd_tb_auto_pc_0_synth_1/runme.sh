...
HD_PWD='D:/xlinx-projects/knight_rider_ip_tb/knight_rider_ip_tb.runs/kn_rd_tb_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kn_rd_tb_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kn_rd_tb_auto_pc_0.tcl

...
HD_PWD='D:/xlinx-projects/knightrider_ip/knight_rd_tb/knight_rd_tb.runs/knightrider_test_2_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knightrider_test_2_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knightrider_test_2_rst_ps7_0_50M_0.tcl

...
HD_PWD='D:/xlinx-projects/knightrider_ip/knight_rd_tb/knight_rd_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knightrider_test_2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source knightrider_test_2_wrapper.tcl -notrace

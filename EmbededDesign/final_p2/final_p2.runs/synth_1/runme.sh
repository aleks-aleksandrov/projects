...
HD_PWD='D:/xlinx-projects/final_p2/final_p2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_fifo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_fifo_wrapper.tcl

...
HD_PWD='D:/xlinx-projects/final_p2/final_p2.runs/stream_fifo_axi_fifo_mm_s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_fifo_axi_fifo_mm_s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_fifo_axi_fifo_mm_s_0_0.tcl

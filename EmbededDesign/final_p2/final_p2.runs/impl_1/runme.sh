...
HD_PWD='D:/xlinx-projects/final_p2/final_p2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_fifo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stream_fifo_wrapper.tcl -notrace

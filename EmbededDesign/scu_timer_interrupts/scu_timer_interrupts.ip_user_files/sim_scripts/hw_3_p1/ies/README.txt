...
#
# Generated by export_simulation on Fri Feb 05 00:27:08 +0200 2021
#
################################################################################
...
'-reset_run' switch to the './hw_3_p1.sh' script.

./hw_3_p1.sh -reset_run
...
./hw_3_p1.sh -noclean_files

For more information on the script, please type './hw_3_p1.sh -help'.

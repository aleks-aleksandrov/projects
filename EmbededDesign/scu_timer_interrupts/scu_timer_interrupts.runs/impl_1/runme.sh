...
HD_PWD='D:/xlinx-projects/scu_timer_interrupts/scu_timer_interrupts.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_3_p1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_3_p1_wrapper.tcl -notrace

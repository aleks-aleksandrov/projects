...
HD_PWD='D:/xlinx-projects/scu_timer_interrupts/scu_timer_interrupts.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_3_p1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_3_p1_wrapper.tcl

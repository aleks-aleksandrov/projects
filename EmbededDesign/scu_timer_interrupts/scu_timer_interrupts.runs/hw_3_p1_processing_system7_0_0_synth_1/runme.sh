...
HD_PWD='D:/xlinx-projects/scu_timer_interrupts/scu_timer_interrupts.runs/hw_3_p1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_3_p1_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_3_p1_processing_system7_0_0.tcl

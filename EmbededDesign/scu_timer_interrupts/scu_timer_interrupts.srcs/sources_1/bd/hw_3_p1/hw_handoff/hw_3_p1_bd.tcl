...
################################################################
# This is a generated script based on design: hw_3_p1
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports btns] [get_bd_intf_pins btns/GPIO]
  ...
  connect_bd_net -net btns_ip2intc_irpt [get_bd_pins btns/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins btns/s_axi_aresetn] [get_bd_pins leds/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

...
HD_PWD='D:/xlinx-projects/final_p1/final_p1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sws_diagram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sws_diagram_wrapper.tcl -notrace

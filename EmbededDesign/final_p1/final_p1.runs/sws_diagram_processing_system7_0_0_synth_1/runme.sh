...
HD_PWD='D:/xlinx-projects/final_p1/final_p1.runs/sws_diagram_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sws_diagram_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sws_diagram_processing_system7_0_0.tcl

...
HD_PWD='D:/xlinx-projects/dma_transfer/dma_transfer.runs/dma_design_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_design_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_design_processing_system7_0_1.tcl

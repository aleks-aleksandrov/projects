...
proc create_ipi_design { offsetfile design_name } {
	...
	set custom_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:custom_ip:1.0 custom_ip_0 ]
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins custom_ip_0/S_AXI]
	connect_bd_net [get_bd_pins custom_ip_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins custom_ip_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_custom_ip_0_S_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:custom_ip:1.0]]]]

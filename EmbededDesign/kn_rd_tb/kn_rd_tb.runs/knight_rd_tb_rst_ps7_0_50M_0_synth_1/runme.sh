...
HD_PWD='D:/xlinx-projects/kn_rd_tb/kn_rd_tb.runs/knight_rd_tb_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rd_tb_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knight_rd_tb_rst_ps7_0_50M_0.tcl

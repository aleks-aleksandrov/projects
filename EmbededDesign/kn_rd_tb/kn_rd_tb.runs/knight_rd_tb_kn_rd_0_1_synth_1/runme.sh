...
HD_PWD='D:/xlinx-projects/kn_rd_tb/kn_rd_tb.runs/knight_rd_tb_kn_rd_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rd_tb_kn_rd_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knight_rd_tb_kn_rd_0_1.tcl

...
HD_PWD='D:/xlinx-projects/kn_rd_tb/kn_rd_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rd_tb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source knight_rd_tb_wrapper.tcl -notrace

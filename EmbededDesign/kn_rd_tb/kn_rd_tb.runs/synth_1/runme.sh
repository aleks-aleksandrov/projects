...
HD_PWD='D:/xlinx-projects/kn_rd_tb/kn_rd_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log knight_rd_tb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source knight_rd_tb_wrapper.tcl

...
HD_PWD='D:/xlinx-projects/blinking_led_practice/blinking_led_practice.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinking_led_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinking_led_design_wrapper.tcl -notrace

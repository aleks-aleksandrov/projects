...
HD_PWD='D:/xlinx-projects/blinking_led_practice/blinking_led_practice.runs/blinking_led_design_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinking_led_design_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinking_led_design_axi_gpio_0_0.tcl

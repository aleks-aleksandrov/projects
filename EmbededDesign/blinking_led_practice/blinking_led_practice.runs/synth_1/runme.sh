...
HD_PWD='D:/xlinx-projects/blinking_led_practice/blinking_led_practice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinking_led_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinking_led_design_wrapper.tcl

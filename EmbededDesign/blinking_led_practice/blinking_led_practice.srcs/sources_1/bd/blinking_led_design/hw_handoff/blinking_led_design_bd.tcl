...
################################################################
# This is a generated script based on design: blinking_led_design
#
...
# source blinking_led_design_script.tcl
...
set design_name blinking_led_design
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net btns_GPIO [get_bd_intf_ports btns] [get_bd_intf_pins btns/GPIO]
  connect_bd_intf_net -intf_net led_GPIO [get_bd_intf_ports leds] [get_bd_intf_pins led/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins btns/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btns/S_AXI/Reg] SEG_btns_Reg

...
HD_PWD='D:/xlinx-projects/count_ones_tb/count_ones_tb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_ones_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_ones_tb.tcl

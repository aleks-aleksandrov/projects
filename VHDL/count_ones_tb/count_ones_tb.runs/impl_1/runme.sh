...
HD_PWD='D:/xlinx-projects/count_ones_tb/count_ones_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_ones_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_ones_tb.tcl -notrace

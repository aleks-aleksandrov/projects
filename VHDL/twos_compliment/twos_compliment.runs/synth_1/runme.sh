...
HD_PWD='D:/xlinx-projects/ECEC302-files/twos_compliment/twos_compliment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array2sC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array2sC.tcl

...
HD_PWD='D:/xlinx-projects/serial_in_sh_reg/serial_in_sh_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sh_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sh_reg.tcl

...
HD_PWD='D:/xlinx-projects/twos_compliment_system/twos_compliment_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twosc_sys_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twosc_sys_tb.tcl

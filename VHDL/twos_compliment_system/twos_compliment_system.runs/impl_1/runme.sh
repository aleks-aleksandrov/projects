...
HD_PWD='D:/xlinx-projects/twos_compliment_system/twos_compliment_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twosc_sys_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twosc_sys_tb.tcl -notrace

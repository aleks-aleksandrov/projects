...
HD_PWD='D:/xlinx-projects/cascadingreg/cascadingreg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cascade_reg4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cascade_reg4.tcl

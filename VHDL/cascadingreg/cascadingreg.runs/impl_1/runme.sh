...
HD_PWD='D:/xlinx-projects/cascadingreg/cascadingreg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cascade_reg4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cascade_reg4.tcl -notrace

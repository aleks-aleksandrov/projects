...
HD_PWD='D:/xlinx-projects/FIFO_IP_design/FIFO_IP_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_hw.tcl

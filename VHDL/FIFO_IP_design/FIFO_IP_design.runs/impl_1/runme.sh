...
HD_PWD='D:/xlinx-projects/FIFO_IP_design/FIFO_IP_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_hw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_hw.tcl -notrace

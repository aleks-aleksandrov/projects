...
HD_PWD='D:/xlinx-projects/stepcascade/stepcascade.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log step_cascade_reg4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source step_cascade_reg4.tcl -notrace

...
HD_PWD='D:/xlinx-projects/stepcascade/stepcascade.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log step_cascade_reg4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source step_cascade_reg4.tcl

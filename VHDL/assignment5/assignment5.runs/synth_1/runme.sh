...
HD_PWD='D:/xlinx-projects/assignment5/assignment5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log radix5_adder_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source radix5_adder_tb.tcl

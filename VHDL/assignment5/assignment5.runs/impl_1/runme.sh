...
HD_PWD='D:/xlinx-projects/assignment5/assignment5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log radix5_adder_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source radix5_adder_tb.tcl -notrace

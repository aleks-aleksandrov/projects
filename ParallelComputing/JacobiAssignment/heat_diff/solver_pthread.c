...
void worker_function (void *args)
{
    ...
    while(!done){
        ...
        //Update diff with p_diff/num_elements (threads will wait here until the lock is free)
        pthread_mutex_lock(thread_data->mutex_for_diff);

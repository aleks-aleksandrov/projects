                    ...
                    float xmax, float xmin, int max_iter, int num_threads)
{
    ...
    */
    #pragma omp parallel private(j,i,r1,r2,curr_fitness,particle,gbest,partial_fitness, private_g) firstprivate(iter) shared(g,best_fitness,w,c1,c2,xmax,xmin,max_iter,function,seed) num_threads(num_threads)
    {
